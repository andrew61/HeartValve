...
namespace HeartValve.Utilites
{
    /// <summary>
    /// GhostScript DLL (gsdll32.dll) Wrapper Class
    /// </summary>
    public class GhostScriptWrapper : IDisposable
    {
        #region Constants
        ...
        private GhostScriptWrapper()
        {
        }
        public GhostScriptWrapper(string libraryPath)
        {
        ...
        public List<string> Convert(OutputDevice outputDevice, DeviceOption[] deviceOptions, string inputFileName, string outputPath, string outputFileName, string temporaryFileFolder, int resolution)
        {
            ...
            {
                throw (new GhostScriptException((int)ReturnCode.FileTypeNotSupportedByInterpreter, GhostScriptWrapper.GetGSErrorMessage((int)ReturnCode.FileTypeNotSupportedByInterpreter)));
            }
